...
def main():
    ...
    parser.add_argument('--vgg16-pkl', default='https://docs.google.com/uc?export=download&id=10dOgqTCdh1rcEScLkWT44SzhD5IbO1sm', help='VGG16 network pickle filename')
